                               ...
                               <table id="example1" class="table table-bordered table-striped table-sm">
                                   ...
                                   foreach ($visitas_datos as $visitas_dato){
                                       ...
                                       <tr>
                                           ...
                                           <td><center><?php echo $visitas_dato['estado'];?></td>
                                           ...
                                           <td>
                                               <center>
                                                   <div class="btn-group">
                                                       ...
                                                       <a href="delete.php?id=<?php echo $id_visita; ?>" type="button" class="btn btn-secondary btn-sm"><i class="fa fa-circle-check"></i> Autorizar</a>
                                                   </div>
                                               </center>
                                           </td>
                                       </tr>
