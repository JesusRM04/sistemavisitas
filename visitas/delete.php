...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Eliminar Visita</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="col-md-12">
                    <div class="card card-danger">
                        <div class="card-header">
                            <h3 class="card-title">¿Está seguro de ELIMINAR esta Visita?</h3>
                        ...
                        <div class="card-body" style="display: block;">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form action="../app/controllers/visitas/delete_visita.php" method="post">
